...
class AudioPlayerViewState extends State<AudioPlayerView> {
  ...
  String _audioUrl = APIpath.ngRok; // Update this with your server URL
  ...
  Widget build(BuildContext context) {
    AudioModel audio = ModalRoute.of(context)?.settings.arguments as AudioModel;
    return Scaffold(
      appBar: AppBar(
